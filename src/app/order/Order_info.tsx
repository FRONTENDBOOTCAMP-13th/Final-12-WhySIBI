...
export default function OrderInfo() {
  ...
  return (
    <section className="border-1 px-5 py-6 rounded-2xl">
      ...
      <div className="flex items-center">
        <label className="text-lg font-basic">연락처</label>
        <input
          ref={firstInputRef}
      ...
      {/* <div className="flex items-center">
        <label className="text-lg font-basic">배송메모</label>
        <div className="flex items-center border-1">
          <select
            name="memo"
            id="memo"
            className='className="w-full text-[#777777] font-semibold cursor-pointer outline-0 appearance-none text-center"'
          >
            <option value="default">배송시 요청사항을 선택해 주세요</option>
            <option value="door">부재시 문앞에 놓아주세요.</option>
            <option value="security">부재시 경비실에 맡겨 주세요.</option>
