<a href="https://final-12-why-sibi.vercel.app/" target="_blank">
...
| **이름**  | **담당 업무**                                                                                  |
| ------- | ------------------------------------------------------------------------------------------ |
| **조현수** | - 팀 리딩 및 프로젝트 관리 <br> - 회원가입 페이지 개발 <br> - 마이 페이지 개발 <br> - 커뮤니티 **자취 상담소** 개발             |
| **김연호** | - 프로젝트 저장소 / DB 관리 <br> - 쇼핑 **상세 페이지** 개발 <br> - 장바구니 개발                                  |
| **정유진** | - README / 위키 작성 <br> - 쇼핑 **카테고리 페이지** 개발 <br> - 쇼핑 **추천 페이지** 개발 <br> - 쇼핑 **검색 페이지** 개발 |
| **김하영** | - 프로젝트 **UI 디자인** <br> - 고객센터 개발 <br> - 커뮤니티 **집들이** 개발                                    |
...
- **회원가입 및 로그인**:
  - 회원가입 시 사용자 정보와 취향 태그가 DB에 등록됩니다.

- **마이페이지**:
  - 회원 정보를 수정하고 주문목록 및 배송현황을 확인할 수 있습니다.
  - 관심 있는 상품과 게시글을 찜하여 마이페이지에서 쉽게 확인할 수 있습니다.

- **쇼핑 페이지 및 검색**:
  - 카테고리별 분류, 인기 상품 필터링, 사용자 취향 기반 상품 추천 기능을 제공합니다.
  - 검색창을 통해 상품을 검색할 수 있습니다. 

- **상품 상세 및 장바구니**:
  - 상품의 상세 정보, 리뷰, 판매자 문의를 확인할 수 있습니다.
  - 상품 옵션을 선택하여 장바구니에 추가 후 구매할 수 있습니다.

- **커뮤니티 자취상담소**:
  - 자취 상담소 Q&A 게시판을 통해 사용자 간 정보 교환이 가능합니다.

- **커뮤니티 집들이**:
  - 집들이 게시판에서 인테리어를 공유하고, 사진과 글을 업로드할 수 있습니다.
<br/>
<br/>
...
### 🏄🏻 김연호
> react, next.js 수업이 조금 어렵게 느껴졌어서 프로젝트를 시작하기 전에는 좀 막막한 마음이 컸습니다. 하지만 팀원들과 모르는 부분은 서로 도와줘가며  차근차근 진행해 나가다보니 한달이라는 프로젝트 기간이 정말 순식간에 지나간거 같습니다.
마지막 프로젝트인 만큼 좋은 결과물을 만들고 싶었는데 너무 좋은 팀원들을 만나서 으쌰으쌰 하며 한달동안 열심히 할수 있었던거 같습니다.
그 과정중에 TypeScript나 Next.js가 아직은 익숙하지 않아서 어려움을 겪기도 했지만 혼자 스스로 찾아보거나 보조강사님들에게 여쭤보며 한층 더 성장할수 있었습니다.
이번 프로젝트를 통해 협업과 소통의 즐거움을 제대로 느낄수 있었고, 개발자로서의 자신감도 조금 더 생긴 것 같습니다.
마지막으로, 왜시비조 팀원분들 한달동안 정말 수고많으셨고, 함께해서 정말 즐거웠습니다!
### 🏄🏻‍♀️ 정유진
...
하지만 지금 돌아보면, 그때 포기하지 않고 끝까지 부딪힌 덕분에 앞으로의 인생에서 자산이 될 경험들을 할 수 있었다고 느낍니다. 완벽하지 않아도 괜찮다는 걸 배웠고, 개발하는 과정에 어려움이 있을 때에도 팀원분들이 코딩하고 협업하는 모습을 보고 배우며 조금씩 성장할 수 있었습니다.<br/>
